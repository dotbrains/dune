...
`pluginRegistry` in user or project settings overrides the appearance plugin catalog
directory URL, and `pluginUpdates` controls the startup appearance-plugin update check.
